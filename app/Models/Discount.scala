...
@Singleton
class Discount @Inject()(configuration: Configuration) extends Card(configuration.underlying.getString("cards.Discount.name"),configuration.underlying.getInt("cards.Discount.cost"),configuration.underlying.getInt("cards.Discount.availableCount"),0.25) {
