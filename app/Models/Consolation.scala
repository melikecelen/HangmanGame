...
@Singleton
class Consolation @Inject()(configuration: Configuration) extends Card(configuration.underlying.getString("cards.Consolation.name"),configuration.underlying.getInt("cards.Consolation.cost"),configuration.underlying.getInt("cards.Consolation.availableCount"), 1) {
